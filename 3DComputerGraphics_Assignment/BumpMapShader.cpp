...
void BumpMapShader::ShutdownShader()
{
...
void BumpMapShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	fout.open("bumpmap-shader-error.txt");
...
bool BumpMapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, 
