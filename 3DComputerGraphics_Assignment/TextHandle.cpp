...
bool TextHandle::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, int screenWidth, int screenHeight, 
...
bool TextHandle::Render(ID3D11DeviceContext* deviceContext, FontShader* FontShader, D3DXMATRIX worldMatrix, D3DXMATRIX orthoMatrix)
{
	bool result;
...
bool TextHandle::InitializeSentence(SentenceType** sentence, int maxLength, ID3D11Device* device)
{
	VertexType* vertices;
...
bool TextHandle::UpdateSentence(SentenceType* sentence, char* text, int positionX, int positionY, float red, float green, float blue,
...
void TextHandle::ReleaseSentence(SentenceType** sentence)
{
	if(*sentence)
	{
...
bool TextHandle::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, FontShader* FontShader, D3DXMATRIX worldMatrix, 
...
bool TextHandle::SetVideoCardInfo(char* videoCardName, int videoCardMemory, ID3D11DeviceContext* deviceContext)
{
	char dataString[150];
	bool result;
	char tempString[16];
...
bool TextHandle::SetFps(int fps, ID3D11DeviceContext* deviceContext)
{
	char tempString[16];
	char fpsString[16];
	bool result;
...
bool TextHandle::SetCpu(int cpu, ID3D11DeviceContext* deviceContext)
{
	char tempString[16];
	char cpuString[16];
	bool result;
...
bool TextHandle::SetCameraPosition(float posX, float posY, float posZ, ID3D11DeviceContext* deviceContext)
{
...
bool TextHandle::SetCameraRotation(float rotX, float rotY, float rotZ, ID3D11DeviceContext* deviceContext)
{
