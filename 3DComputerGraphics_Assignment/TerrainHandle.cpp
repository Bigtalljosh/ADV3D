...
ID3D11ShaderResourceView* TerrainHandle::GetTexture()
{
	return m_Texture->GetTexture();
}

bool TerrainHandle::LoadHeightMap(char* filename)
{
	FILE* filePtr;
	int error;
	unsigned int count;
...
void TerrainHandle::NormalizeHeightMap()
{
	int i, j;
...
bool TerrainHandle::CalculateNormals()
{
...
void TerrainHandle::ShutdownHeightMap()
{
	if(m_heightMap)
	{
		delete [] m_heightMap;
...
void TerrainHandle::CalculateTextureCoordinates()
{
...
bool TerrainHandle::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;


	// Create the texture object.
	m_Texture = new TextureHandle;
	if(!m_Texture)
	{
		return false;
	}
...
void TerrainHandle::ReleaseTexture()
{
...
bool TerrainHandle::InitializeBuffers(ID3D11Device* device)
{
...
void TerrainHandle::ShutdownBuffers()
{
	// Release the vertex array.
	if(m_vertices)
	{
...
int TerrainHandle::GetVertexCount()
{
	return m_vertexCount;
}

void TerrainHandle::CopyVertexArray(void* vertexList)
{
